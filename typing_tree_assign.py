...
def typing_tree_assign(typing_tree, term, comb, classKconstantDict):
  ...
  if(term == 'b'):
    ...
    if(int(atoms[0]) == 1 or int(atoms[0]) in range(16,29)):
      for i in lists_1:
        ...
        if(comb_1 in classKconstantDict):
          return (comb, float(classKconstantDict[comb_1]))
        elif(comb_2 in classKconstantDict):
          return (comb, float(classKconstantDict[comb_2]))
    ...
    if(int(atoms[0]) in range(32,36) and int(atoms[1]) in range(32,36)):
      for i in range(32,36):
        for j in range(32,36):
          ...
          if(comb_1 in classKconstantDict):
            collect.append((comb_1,float(classKconstantDict[comb_1])))
            collect_1.append(float(classKconstantDict[comb_1]))
          elif(comb_2 in classKconstantDict):
            collect.append((comb_2,float(classKconstantDict[comb_2])))
            collect_1.append(float(classKconstantDict[comb_2]))
...
#for k in comb:
#  i = typing_tree_assign(a, 'o', k, classKconstantDict)
#  atoms = i[0].split('_')
